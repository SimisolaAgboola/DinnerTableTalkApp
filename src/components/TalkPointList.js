...
//         try {
//             const pipe = await pipeline(); // Initialize the pipeline asynchronously
//             const summarizer = await pipe("summarization", "bart-large-cnn"); // Specify model and task
//             const response = await summarizer(article.description);
//             return {
//                 title: article.title,
//                 url: article.url,
//                 urlToImage: article.urlToImage,
//                 description: response[0].summary_text,
//             };
//         } catch (error) {
...
//                 url: article.url,
//                 urlToImage: article.urlToImage,
//                 description: "Failed to summarize article due to API or memory issue"
//             };
//         }
//     };
